      ...
      <footer className="py-12 border-t border-white/5 relative z-10 bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-foreground/50">
            ...
            <a href="https://linkedin.com/in/fescarvalho" target="_blank" rel="noopener noreferrer" className="hover:text-cyan transition-colors">
              <Linkedin size={20} />
            </a>
            <a href="https://instagram.com/fescarvalho" target="_blank" rel="noopener noreferrer" className="hover:text-cyan transition-colors">
              <Instagram size={20} />
            </a>
          </div>
        </div>
